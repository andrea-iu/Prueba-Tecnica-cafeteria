                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) {?>
                                <tr>
                                    ...
                                    <td> <a href="#" data-href="<?php echo base_url().'/categorias/reingresar/'.$dato['id']; ?>" type="button"  data-toggle="modal" data-target="#modalconfirma" title="Restaurar registro" class="btn btn-success"><i class="fas fa-arrow-circle-up"></i></a></td>
                                </tr>
                           <?php } ?>
                        </tbody>
                    </table>
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                      ...
                      <div class="modal-body">
                          <p>¿Desea retaurar esta Categoria?</p>
                      </div>
