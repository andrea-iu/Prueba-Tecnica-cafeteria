...
<main>
    <div class="container-fluid">
        <h4 class="mt-4"><?php echo $titulo; ?></h4>
          ...
          <div>
              <p>
                  <a href="<?php echo base_url();?>/productos" class="btn btn-success">Unidades</a>
              </p>
          </div>
                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) {?>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="#" data-href="<?php echo base_url().'/productos/reingresar/'.$dato['id']; ?>" type="button"  data-toggle="modal" data-target="#modalconfirma" title="Restaurar registro" class="btn btn-success"><i class="fas fa-arrow-circle-up"></i></a></td>
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                      ...
                      <div class="modal-body">
                          <p>¿Desea retaurar este Producto??</p>
                      </div>
